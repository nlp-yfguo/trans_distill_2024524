...
from loss.distill_base2 import LabelSmoothingLoss,nll_loss,distillloss
...
import cnfg.distill_base2 as cnfg
...
max_batch_id = min(len(low_tl),len(middle_tl),len(high_tl))
