...
class Decoder(DecoderBase):
	...
	def decode(self, inpute, enc_context, context, src_pad_mask=None, context_mask=None, beam_size=1, max_len=512, length_penalty=0.0, fill_pad=False, **kwargs):

		return self.beam_decode(inpute, enc_context, context, src_pad_mask, context_mask, beam_size, max_len, length_penalty, fill_pad=fill_pad, **kwargs) if beam_size > 1 else self.greedy_decode(inpute, enc_context, context, src_pad_mask, context_mask, max_len, fill_pad=fill_pad, **kwargs)

	def greedy_decode(self, inpute, enc_context, context, src_pad_mask=None, context_mask=None, max_len=512, fill_pad=False, sample=False, **kwargs):
	...
	def beam_decode(self, inpute, enc_context, context, src_pad_mask=None, context_mask=None, beam_size=8, max_len=512, length_penalty=0.0, return_all=False, clip_beam=clip_beam_with_lp, fill_pad=False, **kwargs):
