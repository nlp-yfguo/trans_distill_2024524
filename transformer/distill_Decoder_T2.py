...
class Decoder(nn.Module):
	...
	def forward(self, inpute, inputo, src_pad_mask=None, **kwargs):
		...
		out_divT_beforsoftmax = out / T
		out_softmax_withoutT = nn.functional.softmax(out, dim=-1)
		out_sotfmax_byT = nn.functional.softmax(out_divT_beforsoftmax, dim=-1)
		out = out_softmax_withoutT.log()

		return out_softmax_withoutT, out_sotfmax_byT, out
