...
group_id = "max_std_twoTea_403030sample_newdistill"

run_id = "teacher_FTfinetune/newloss"

data_id = "encs_1div3_cache_3072"

exp_dir = "expm/"
cache_dir = "wmt15/"

low_train_data = root_dir + cache_dir + data_id + "/low_train_3072.h5"
middle_train_data = root_dir + cache_dir + data_id + "/middle_train_3072.h5"
high_train_data = root_dir + cache_dir + data_id + "/high_train_3072.h5"
dev_data = root_dir + cache_dir + data_id + "/dev.h5"
test_data =root_dir +  cache_dir + data_id + "/test.h5"

fine_tune_m = None

fine_tune_teach = "/home/yfguo/transformer_924/expm/encs_1div3_cache/baseFT300k_1div3finetune/std/checkpoint_0.h5"
fine_tune_student = "/home/yfguo/transformer_924/expm/encs_temp/rs/base/std/checkpoint_3.h5"
fine_tune_high_teach="/home/yfguo/transformer_924/expm/encs_temp/rs/baseFT300k/std/avg.h5"
