...
group_id = "std_A1B04_total_data_newdistill"

run_id = "teacher_FTfinetune/newloss"

data_id = "encs_temp/rs_6144"

exp_dir = "expm/"
cache_dir = "wmt15/"

train_data = root_dir + cache_dir + data_id + "/train_6144.h5"
dev_data = root_dir + cache_dir + data_id + "/dev_6144.h5"
