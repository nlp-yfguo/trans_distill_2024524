...
group_id = "baseFT300k_1div3finetune"

run_id = "std"

data_id = "encs_1div3_cache"

exp_dir = "expm/"
cache_dir = "wmt15/"

train_data = root_dir + cache_dir + data_id + "/low_train.h5"
dev_data = root_dir + cache_dir + data_id + "/dev.h5"
test_data = root_dir + cache_dir + data_id + "/test.h5"

fine_tune_m="/home/yfguo/transformer_924/expm/encs_temp/rs/baseFT300k/std/avg.h5"
