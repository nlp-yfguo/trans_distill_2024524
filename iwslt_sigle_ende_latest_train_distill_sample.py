...
import cnfg.iwslt_sigle_deen_latest_distill_base as cnfg
from cnfg.ihyp import *
from cnfg.vocab.base import pad_id


def train(low_td,middle_td,high_td, tl, ed, nd, optm, lrsch, teach_model,stu_model, lossf,distilllossf, mv_device, logger, done_tokens, multi_gpu, multi_gpu_optimizer,
...
if fine_tune_teach is None:
    ...
    if cnt_states is not None:
        ...
        if "training_list" in _remain_states:
            ...
            shuffle(tl)
            _ctl = tl
        tminerr, done_tokens, cur_checkid, remain_steps, _ = train(low_td, middle_td, high_td, _ctl, vd, nvalid, stu_optimizer, stu_lrsch, teach_model,student_model,
...
for i in range(1, maxrun + 1):
    shuffle(tl)
    free_cache(use_cuda)
    terr, done_tokens, cur_checkid, remain_steps, _Dws = train(low_td,middle_td,high_td, tl, vd, nvalid, stu_optimizer, stu_lrsch, teach_model,student_model, lossf,distilllossf,
